...
class AlpPopinjay:
    ...
    def _set_params(self, params:dict) -> None:
        ...
        self.up_thd = params["up_thd"]
        self.down_thd = params["down_thd"]

    def generate_buy_price(self, kdf:pd.DataFrame) -> dict:       
    ...
    def get_backtest_result(
        ...
        self._set_params(params)
        strategy = StgyMakerjay(money = self.money, up_thd = self.up_thd, down_thd = self.down_thd)
    ...
    def objective(self, trial):
        kwargs = {
            ...
            "up_thd": trial.suggest_float("up_thd", 0.01, 0.2, step=0.01),
            "down_thd": trial.suggest_float("down_thd", 0.01, 0.2, step=0.01),
        }
...
if __name__ == "__main__":
    params = {'atr_len': 9, 'up_thd': 0.09, 'down_thd': 0.07}
    def backtest(params):
