...
class StgyTriplemaSplit(BacktestEngine):
    """this strategy contains technicals of 3 ema and Atr, which aims to change position with candle's too far away from dema based on atr"""
