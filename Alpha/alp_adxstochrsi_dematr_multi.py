...
if __name__ == "__main__":
    ...
    def live_trading(params):
        timbersaw.setup()
        alp = AlpAdxStochrsiDematrMulti(money = 500, leverage = 5, params = params, mode = 1)
    ...
    def backtest(params):
        alp_backtest = AlpAdxStochrsiDematrMulti(money = 500, leverage = 5, params = params, mode = 0)
